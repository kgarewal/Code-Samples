...
describe AppointmentsController do
  ...
  let(:valid_attributes) { { "date_of_visit" => "" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested appointment" do
        ...
        Appointment.any_instance.should_receive(:update).with({ "date_of_visit" => "" })
        put :update, {:id => appointment.to_param, :appointment => { "date_of_visit" => "" }}, valid_session
      end
